...
for i in range(numIter):
    ...
    betahat, bThetahat, _, numI, Berrs, Terrs = MCGDBern(2000, X, Y, R, sXs, conDenfs, TrueParas=TrueParas, eta=eta, Cb=Cb, CT=CT, tol=tol, log=2, ST=ST, prob=prob, betainit=betainit, bThetainit=bThetainit, ErrOpts=1)
