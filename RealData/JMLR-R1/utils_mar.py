...
#----------------------------------------------------------------------------------------------------------------
# Compute the value of first derivative of L w.r.t beta for any distributions X under MAR setting
...
def MarRealDataAlg(MaxIters, X, Y, R, conDenfs, Cb=10, CT=1, etab=1e-3, etaT=1, log=0, bThetainit=None, betainit=None, tols=None, prob=0.5, ErrOpts=0):
    """
